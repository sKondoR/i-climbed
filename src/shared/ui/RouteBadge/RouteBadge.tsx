...
const RouteBadge = ({
  ...
  return (
    <span className="w-14 h-14 md:w-s17 md:h-17 rounded-full text-md md:text-xl inline-block text-center text-white bold pt-4 md:pt-5" style={{ background: bg }}>{formattedGrade}</span>
  );
};
